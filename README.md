## perception_pcl (lyrical) - 2.9.0-1

The packages in the `perception_pcl` repository were released into the `lyrical` distro by running `/home/cottsay/infra_ws/install/bin/bloom-release perception_pcl -r lyrical --unsafe` on `Wed, 29 Apr 2026 23:29:10 -0000`
...
## perception_pcl (rolling) - 2.9.0-1

The packages in the `perception_pcl` repository were released into the `rolling` distro by running `/usr/bin/bloom-release perception_pcl --rosdistro rolling --track rolling --edit` on `Wed, 29 Apr 2026 23:15:54 -0000`
...
## perception_pcl (jazzy) - 2.6.4-1

The packages in the `perception_pcl` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy perception_pcl` on `Tue, 17 Feb 2026 14:56:15 -0000`
...
## perception_pcl (rolling) - 2.8.0-1

The packages in the `perception_pcl` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling perception_pcl` on `Thu, 12 Feb 2026 15:58:30 -0000`
...
## perception_pcl (rolling) - 2.7.4-1

The packages in the `perception_pcl` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling perception_pcl` on `Fri, 09 Jan 2026 16:28:20 -0000`
...
## perception_pcl (kilted) - 2.7.3-1

The packages in the `perception_pcl` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --track kilted perception_pcl` on `Thu, 05 Jun 2025 07:13:42 -0000`
...
## perception_pcl (rolling) - 2.7.3-1

The packages in the `perception_pcl` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling perception_pcl` on `Thu, 05 Jun 2025 07:11:13 -0000`
...
## perception_pcl (kilted) - 2.7.2-1

The packages in the `perception_pcl` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --track kilted perception_pcl` on `Mon, 26 May 2025 08:55:47 -0000`
...
## perception_pcl (rolling) - 2.7.2-1
...
## perception_pcl (rolling) - 2.7.1-1
...
## perception_pcl (rolling) - 2.6.3-1
...
The packages in the `perception_pcl` repository were released into the `humble` distro by running `/usr/bin/bloom-release perception_pcl --track humble --ros-distro humble` on `Tue, 20 Aug 2024 15:56:02 -0000`
...
The packages in the `perception_pcl` repository were released into the `humble` distro by running `/usr/bin/bloom-release perception_pcl --rosdistro humble --track humble` on `Thu, 15 Aug 2024 19:43:50 -0000`
